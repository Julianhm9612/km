			...
			<div class="row no-container">
				<div class="col-xs-4 col-sm-4 col-md-4">
					<div style="padding: 80px 0px;">
						<h1 style="margin-bottom: 20px; font-size: 38px;">KM a knowledge management system</h1>
						{{--  <p class="minor-text" style="margin-bottom: 25px; font-size: 18px;">KM let you document who you are, what you do and how to achieve results.</p>  --}}
